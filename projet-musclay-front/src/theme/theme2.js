...
export const getDesignTokens = (mode) => (
  {
    palette: {
      primary: {
        ...blue,
        // YD couleur navbar et footer light mode
        main: blueDark[400],
        // YD couleur bouton
        500: blueDark[600],
        // YD couleur hover bouton
        700: blueDark[800],
        ...(mode === 'dark' && {
          main: blue[800],
          500: blue[500],
    ...
    typography: {
      ...
      // Modification for ErrorPage
      h3: {
        fontSize: 'clamp(1.5rem, 0.9643rem + 1.4286vw, 2.25rem)',
        lineHeight: 44 / 36,
        fontWeight: 800,
        letterSpacing: 0,
        color: mode === 'dark' ? grey[200] : blueDark[900],
      },
      h4: {
      ...
      body3: {
        ...
        lineHeight: 21 / 14,
        letterSpacing: 0,
        color: mode === 'dark' ? blue[600] : blueDark[400],
      },
      caption: {
    ...
    components: {
      ...
      MuiPaper: {
        styleOverrides: {
          root: {
            backgroundColor:
            // YD Style Nav et footer en dark et card color en light
              theme.palette.mode === 'dark' ? theme.palette.primaryDark[900] : '#eff0f3',
            '&[href]': {
...
export const brandingDarkTheme = (mode) => deepmerge(createTheme(getDesignTokens(mode)), getThemedComponents(createTheme(getDesignTokens(mode))));
