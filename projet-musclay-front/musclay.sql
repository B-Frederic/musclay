...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : dim. 21 août 2022 à 12:36
...
(97, 'Le Power Clean', 'Comme vous avez pu le constater, je suis toujours à la recherche de nouveaux exercices pour varier un peu Entraînements et \r\n    éviter la routine. Aujourd’hui, nous nous intéressons au Power Clean, une version « bodybuilding » de l\'épaulé des haltérophiles.', '2022-08-14 19:36:53', NULL),
...
(1, '2022-08-16 22:22:40', NULL, 1, 1),
(2, '2022-08-16 22:22:40', NULL, 2, 1),
(3, '2022-08-16 22:22:40', NULL, 3, 2);
...
CREATE TABLE IF NOT EXISTS `sets` (
  ...
  `exercise_id` int(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_sets_sessions` (`session_id`),
...
INSERT INTO `statistics` (`id`, `set_number`, `repetitions`, `weight`, `score`, `comment`, `created_at`, `updated_at`, `user_id`, `exercise_id`) VALUES
(1, 1, 10, 60, 3, 'EZ', '2022-08-19 09:35:09', NULL, 4, 1),
(2, 1, 15, 80, 5, 'hot', '2022-08-19 09:51:32', NULL, 3, 1),
(3, 1, 15, 80, 5, 'hot', '2022-08-19 10:21:17', NULL, 4, 2),
(5, 1, 15, 900, 2, 'SoEz', '2022-08-18 22:00:00', NULL, 4, 1),
(6, 2, 170, 920, 2, 'SoEz', '2022-08-18 22:00:00', NULL, 4, 1),
(7, 3, 2, 950, 2, 'SoEz', '2022-08-18 22:00:00', NULL, 4, 1),
(8, 4, 15, 909, 2, 'SoEz', '2022-08-18 22:00:00', NULL, 4, 1),
(9, 1, 12, 90, 4, 'okay', '2022-08-19 12:40:33', NULL, 4, 25),
(10, 1, 12, 5, 5, 'hard bien mais facile', '2022-08-19 13:32:50', NULL, 4, 6),
(11, 1, 12, 5, 5, 'hard bien mais facileeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', '2022-08-19 13:40:01', NULL, 4, 6),
(13, 1, 12, 5, 5, 'hard bien mais facile', '2020-08-16 22:00:00', NULL, 4, 6),
(14, 1, 15, 86, 5, 'zef', '2022-08-14 22:00:00', NULL, 4, 9),
(15, 2, 15, 86, 5, 'test', '2022-08-14 22:00:00', NULL, 4, 9),
(16, 2, 15, 86, 5, 'ezf', '2022-08-11 22:00:00', NULL, 4, 9),
(17, 1, 12, 40, 5, 'hard bien mais facile', '2022-08-20 10:25:14', NULL, 4, 6),
(18, 2, 12, 50, 5, 'hard bien mais facile', '2022-08-20 10:25:14', NULL, 4, 6),
(19, 3, 12, 60, 5, 'hard bien mais facile', '2022-08-20 10:25:14', NULL, 4, 6),
(20, 4, 12, 70, 5, 'hard bien mais facile', '2022-08-20 10:25:14', NULL, 4, 6),
(21, 1, 12, 70, 5, 'hard', '2022-08-20 22:00:00', NULL, 4, 6),
(22, 1, 12, 50, 5, 'hard', '2022-08-16 22:00:00', NULL, 4, 6),
(23, 1, 12, 45, 5, 'hard', '2022-08-15 22:00:00', NULL, 4, 6),
(24, 1, 12, 40, 5, 'hard', '2022-08-14 22:00:00', NULL, 4, 6);
...
(1, 'Prise de masse', '2022-08-14 11:57:32', NULL, 4),
(2, 'sèche', '2022-08-14 21:58:32', NULL, 2),
(3, 'Full body', '2022-08-14 21:58:32', NULL, 4),
(4, 'Legs', '2022-08-18 18:01:03', NULL, 4);
...
(5, 'Siaka', 'Siaka@exemple.com', NULL, '$2y$10$jEmGrAp/kBJf/JNTSXWDpO4IqCVBUSqkc4cnRuA/qNFSIpagKQjBO', NULL, '2022-08-16 08:41:32', '2022-08-16 08:41:32'),
(6, 'test', 'test@test.com', NULL, '$2y$10$ZBjPQxhWIoPBL19GIqfAxOlNIkRuE3HZ0nY7bwpqouM0CMHsm8Y.u', NULL, '2022-08-16 12:06:21', '2022-08-16 12:06:21'),
(7, 'newuser', 'newuser@test.com', NULL, '$2y$10$DS55hqPZlU5jKGriogXqFev3ON0zUwoJA5MTE2NWzfQOqLqIKYHyy', NULL, '2022-08-16 12:10:12', '2022-08-16 12:10:12'),
(8, 'testtes', 'fezfze@gt.fr', NULL, '$2y$10$JmqHczCZN6Jepv4MfTNdH.eePrPoyz02CdZMmCVQHTGbkUu0lBHTC', NULL, '2022-08-16 12:17:15', '2022-08-16 12:17:15'),
(9, 'testestes', 'ezfze@fgzef.fr', NULL, '$2y$10$FuDGMFJMcAYdgU28myInquzxTVkmNl4KuTPFzKiRujJP/WotAhq/6', NULL, '2022-08-16 12:18:28', '2022-08-16 12:18:28'),
(10, 'testestesazdaz', 'ezfze@fgazdzef.fr', NULL, '$2y$10$3uNVbgg9db0CUYaktcgSS.l39riByvHwekq6m3z4Clhf2M/AIrfVG', NULL, '2022-08-16 12:19:09', '2022-08-16 12:19:09'),
(11, 'azfzef', 'zefzef@greg.gt', NULL, '$2y$10$fpnebNK1mhjzP2hPcsQh4uMROMK.zyQaR5o6gJewMDBVcZVU60bq6', NULL, '2022-08-16 12:19:57', '2022-08-16 12:19:57'),
(12, 'azfzefazda', 'zefzef@grazdazeg.gt', NULL, '$2y$10$mcXj/Kmo8NsF9G0Q8Zzj2e/jJ/PDmQWzg88QZPHnGw10Lw14kGUAK', NULL, '2022-08-16 12:20:11', '2022-08-16 12:20:11'),
(13, 'azfzefazdaazdazd', 'zefzef@grazdazdazeg.gt', NULL, '$2y$10$vVioUtJmQZa6y3Hq0z3uOeEcX0dp7O3v4CJZxnrZJAd6GFwgiJjIG', NULL, '2022-08-16 12:20:28', '2022-08-16 12:20:28'),
(14, 'profiltest', 'profil@test.com', NULL, '$2y$10$XB.r3781ofDXjcbM6W.te.uD2bjjfPice3va5CnABSlRpofCFVD9q', NULL, '2022-08-16 13:03:23', '2022-08-16 13:03:23');
...
ALTER TABLE `sessions`
  ADD CONSTRAINT `FK_sessions_trainings` FOREIGN KEY (`training_id`) REFERENCES `trainings` (`id`);

--
-- Contraintes pour la table `sets`
--
ALTER TABLE `sets`
  ADD CONSTRAINT `FK_sets_exercises` FOREIGN KEY (`exercise_id`) REFERENCES `exercises` (`id`),
  ADD CONSTRAINT `FK_sets_sessions` FOREIGN KEY (`session_id`) REFERENCES `sessions` (`id`);
